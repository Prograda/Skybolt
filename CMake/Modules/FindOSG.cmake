...
ELSE (_osg_IN_CACHE)
	...
	FOREACH(COMPONENT ${OSG_FIND_COMPONENTS})
		...
		FIND_LIBRARY(OSG_${UPPERCOMPONENT}_LIBRARY_RELEASE
			...
			PATH_SUFFIXES lib osgPlugins-${OSG_VERSION} lib/osgPlugins-${OSG_VERSION}
		)
	...
	IF(OSG_INCLUDE_DIR)
		...
		FOREACH(COMPONENT ${OSG_FIND_COMPONENTS})
			...
			IF(NOT OSG_${COMPONENT}_FOUND)
				LIST(APPEND _OSG_MISSING_COMPONENTS ${COMPONENT})
				SET( OSG_FOUND FALSE)
			ENDIF(NOT OSG_${COMPONENT}_FOUND)
		ENDFOREACH(COMPONENT)
	ELSE(OSG_INCLUDE_DIR)
	...
	ELSE (OSG_FOUND)
		...
		IF (OSG_FIND_REQUIRED)
			MESSAGE(FATAL_ERROR "Couldn't find the OSG libraries and/or include directory. Missing: ${_OSG_MISSING_COMPONENTS}.")
