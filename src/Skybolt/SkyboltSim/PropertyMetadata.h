...
struct PropertyMetadataNames
{
	...
	static constexpr const char* attributeType = "AttributeType"; //!< Value is AttributeType enum giving information about the representational meaning of the property values
